  ...
  return (
    <header className="page-header blog-header section-padding pb-0">
          ...
          <div className="col-lg-10">
            <div className="caption">
              <h1 className="fz-55 mt-30">
                Jhamkudi Week 1 Box Office: Gujarati horror-com trends
                extraordinarily; Nets 5.50 crores to emerge a super-hit
              </h1>
            </div>
      ...
      <div
        ...
        data-background="/assets/images3/blogs/movie1.webp"
      ></div>
    </header>
  );
}
