    ...
    <section className="portfolio section-padding">
      <div className="container">
        <div className="col-lg-4">
          <h6>
            <span className="fz-14">03 . </span> Upcomming Projects
          </h6>
        </div>
        ...
        <div className="work-row">
          {data.map((item, index) => (
            <div
              className={`item bord-thin-top ${
                index === data.length - 1 ? "bord-thin-bottom" : ""
              }`}
              key={item.id}
            >
              <div className="row">
                ...
                <div className="col-lg-5 d-flex align-items-end">
                  <div className="cont">
                    {/* <p>{item.text}</p> */}
                    <Link href="" className="mt-30 ls1 sub-title text-white">
                      View Project{" "}
                      <i className="ml-5">
                        <svg
                          width="18"
