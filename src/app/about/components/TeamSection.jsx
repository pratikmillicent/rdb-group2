      ...
      <div className="team-column details-column">
        <div className="team-details">
          ...
          <div className="social-media-links">
            <Link href={teamMembers[hoveredMember].social.facebook}>
              <FaFacebook />
            </Link>
            <Link href={teamMembers[hoveredMember].social.twitter}>
              <FaTwitter />
            </Link>
            <Link href={teamMembers[hoveredMember].social.instagram}>
              <FaInstagram />
            </Link>
          </div>
        </div>
