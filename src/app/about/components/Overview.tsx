...
const OverviewData = [
  {
    id: 1,
    name: "Dhaval Thakkar",
    image: "/assets/images2/Dhaval.webp",
    description:
      "WITH OVER 2 decades OF REAL ESTATE EXPERIENCE, SPECIALISING IN COMMERCIAL AND RETAIL SPACES ACROSS MUMBAI AND GUJARAT, DHAVAL HAS PERSONALLY LED PROJECT MARKETING INITIATIVES FOR NUMEROUCOMMERCIAL PROJECTS IN AND AROUND MUMBAI. HE HAS ALSO DELIVERED OVER 1.5 MILLION SQ. FT. ACROSS 14 CITIES IN INDIA AND HAS STRIVED TO BRING AN ELEMENT OF PROFESSIONALISM TO THE UNORGANIZED REAL ESTATE SECTOR. HE HAS ALSO BEEN AN ARDEN SUPPORTER FOR THE ADOPTION OF TECHNOLOGY FOR BETTER BUSINESS MANAGEMENT, BUSINESS EXPANSION AND SOCIAL OUTREACH, INSPIRING A SENSE OF CONFIDENCE AND REASSURANCE AMONG HIS 700+ HAPPY CUSTOMERS. HE IS ALSO MOVING INTO NEWER FACETS OF REAL ESTATE AS DIRECTOR OF FRACROSPACE A NEW VENTURE DEALING IN FRACTIONAL OWNERSHIP OF PROPERTIES.",
  },
  {
    id: 2,
    image: "/assets/images2/Raj.webp",
    name: "Raj Thakkar",
    description:
      "WITH OVER 2 decades OF EXPERIENCE IN HIS FAMILY'S REAL ESTATE BUSINESS, RAJ HAS LENT HIS FOCUS TO RESIDENTIAL REAL ESTATE IN MUMBAI. HE HAS DELIVERED MORE THAN 1.2 MILLION SQ. FT. EXCLUSIVELY LEADING SEVERAL PROJECT MARKETING INITIATIVES WITH SOME LEADING DEVELOPERS. OVER THE YEARS, HE HAS SOUGHT TO ADD AN ELEMENT OF TRANSPARENCY TO ALL ASPECTS OF THE BUSINESS, PRIORITISING RELATIONSHIPS OVER DEALS. HIS CHARMING AND FRIENDLY NATURE ADD A CERTAIN WARMTH TO THE BUSINESS, WHILE HIS DEDICATION AND PROFESSIONALISM HAVE EARNED HIM THE TRUST OF MANY SATISFIED CUSTOMERS.",
  },
];

const overview = {
  vision: "/assets/images2/vision.webp",
