...
const OverviewData = [
  {
    ...
    description:
      "WITH OVER 20 years OF REAL ESTATE EXPERIENCE, SPECIALISING IN COMMERCIAL AND RETAIL SPACES ACROSS MUMBAI AND GUJARAT, DHAVAL HAS PERSONALLY LED PROJECT MARKETING INITIATIVES FOR NUMEROUCOMMERCIAL PROJECTS IN AND AROUND MUMBAI. HE HAS ALSO DELIVERED OVER 1.5 MILLION SQ. FT. ACROSS 14 CITIES IN INDIA AND HAS STRIVED TO BRING AN ELEMENT OF PROFESSIONALISM TO THE UNORGANIZED REAL ESTATE SECTOR. HE HAS ALSO BEEN AN ARDEN SUPPORTER FOR THE ADOPTION OF TECHNOLOGY FOR BETTER BUSINESS MANAGEMENT, BUSINESS EXPANSION AND SOCIAL OUTREACH, INSPIRING A SENSE OF CONFIDENCE AND REASSURANCE AMONG HIS 700+ HAPPY CUSTOMERS. HE IS ALSO MOVING INTO NEWER FACETS OF REAL ESTATE AS DIRECTOR OF FRACROSPACE A NEW VENTURE DEALING IN FRACTIONAL OWNERSHIP OF PROPERTIES.",
  },
  {
    id: 2,
