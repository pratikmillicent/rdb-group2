...
function SideImage() {
  ...
  function openVideo(event: any) {
    event.preventDefault();
    setVideoDetails({ videoId: "5OoYcqw6nXs", channel: "youtube" });
    setIsVideoOpen(true);
  }
    ...
    <section className="sideimg-numbers section-padding sub-bg">
      ...
      >
        <div className="vid-circle bg-white text-dark">
          <a
            href="https://youtu.be/5OoYcqw6nXs?si=sXvnZ8tqSqAwAVxy"
            className="vid"
            onClick={openVideo}
          >
            <span className="icon">
      ...
      <ModalVideo
        isOpen={isVideoOpen ? videoDetails : null}
